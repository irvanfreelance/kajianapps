...
export const styles = {
  ...
  modalOverlay: { position: "fixed" as const, inset: 0, background: "rgba(15,23,42,0.5)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(4px)", padding: 20 },
  modalContentBase: { background: "#fff", borderRadius: 20, width: "100%", maxWidth: 600, maxHeight: "90vh", overflowY: "auto" as const, boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" },
  modalHeader: { padding: "20px 24px", borderBottom: "1px solid #F1F5F9", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky" as const, top: 0, background: "#fff", zIndex: 10 },
  ...
  toast: { position: "fixed" as const, top: 24, right: 24, background: "#0F172A", color: "#fff", padding: "12px 20px", borderRadius: 12, zIndex: 300, display: "flex", alignItems: "center", gap: 10, fontWeight: 600, fontSize: 14, boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1)" },
};
